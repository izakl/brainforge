...
- The public mirror is published as a clean snapshot by the maintainer's
  `sync-public.sh` (a prep-only script, not part of the published tree), which
  scrubs authorship trailers and internal names — the secret scan is an
  additional backstop.
